...
$(_1f0).tooltip("templates.lunBo.show",e);
...
dlg.dialog($.extend({},opts,{noheader:(opts.title?false:true),openAnimation:(opts.showType),closeAnimation:(opts.showType=="templates.lunBo.show"?"hide":opts.showType),openDuration:opts.showSpeed,closeDuration:opts.showSpeed,onOpen:function(){
...
if(_427){
$(_426).menu("templates.lunBo.show",{menu:_427,parent:item});
}
}
};
function _428(e){
...
mm.menu("templates.lunBo.show",{alignTo:btn,align:opts.menuAlign});
}
btn.blur();
};
...
_4b4.options.err(_4b3,_4b4.message,"templates.lunBo.show");
};
function _4b5(e){
...
if((t.is(":focus")&&_4bc.validating)||_4bb=="templates.lunBo.show"){
t.tooltip($.extend({},opts.tipOptions,{content:_4ba,position:opts.tipPosition,deltaX:opts.deltaX,deltaY:opts.deltaY})).tooltip("templates.lunBo.show");
}
}
};
function _4bd(_4be){
