...
public class OSSClientUtil implements Serializable {
    ...
    // accessKey
    private String accessKeyId = "LTAIzS0jnR3wxXBS";
    private String accessKeySecret = "8XZh5UcAM9ZBrKd5HobgWS64AU4xkZ";
    // 空间
    private String bucketName = "chenkaige";
    // 文件存储目录
    private String filedir = "chenkaige/";
