...
public class OSSClientUtil implements Serializable {
    ...
    // accessKey
    private String accessKeyId = "LTAIONB1l2dsZoGb";
    private String accessKeySecret = "XS3F1sSXNwbnSnUw5Qx2O1bjJ3211v";
    // 空间
    private String bucketName = "wangzhankun";
    // 文件存储目录
    private String filedir = "wangzhankun/";
